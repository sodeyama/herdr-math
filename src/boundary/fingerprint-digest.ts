...
export function formulaFingerprintDigest(
  formula: Pick<Formula, "latex" | "display">,
  secret: Uint8Array
): FingerprintDigest {
  return fingerprintDigest("formula", `${formula.display ? "display" : "inline"}\0${formula.latex}`, secret);
}
